...
<head>
    ...
    <title>@yield('title', \App\Models\Setting::getValue('nama_toko', 'Brew & Co.')) - Sistem Kasir</title>
    <!-- Fonts -->
        ...
        <aside class="sidebar">
            <div class="brand">
                ...
                <div class="brand-text">
                    <span class="brand-name">{{ \App\Models\Setting::getValue('nama_toko', 'Brew & Co.') }}</span>
